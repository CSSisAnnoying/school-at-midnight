...
// function sendMessageBack(styles) {
//     chrome.tabs.query({ active: true, currentWindow: true }, (tabs) => {
//         chrome.tabs.sendMessage(tabs[0].id, { styles });
//     });
// }
...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
    ...
    if (message === "getDarkModeStyle") {
        // sendMessageBack(darkModeStyle);
        sendResponse(darkModeStyle);
        return true;
    }
});